...
namespace RedMango_API.Migrations
{
    ...
    [Migration("20231223152529_ShoppinCartItem")]
    partial class ShoppinCartItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RedMango_API.Migrations.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RedMango_API.Migrations.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedMango_API.Migrations.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedMango_API.Migrations.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RedMango_API.Migrations.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RedMango_API.Migrations.Models.CartItem", b =>
                {
                    b.HasOne("RedMango_API.Migrations.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RedMango_API.Migrations.Models.ShoppingCart", null)
                        .WithMany("CartItems")
